...
const SECTIONS = [
  { title: '1. Acceptance of Terms', body: 'By downloading, installing, or using the BookVault application ("App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.' },
  { title: '2. Use of the App', body: 'BookVault grants you a limited, non-exclusive, non-transferable, revocable license to use the App for personal, non-commercial purposes. You may not copy, modify, distribute, sell, or lease any part of our services or included software.' },
  ...
  { title: '5. Content', body: 'All books, audiobooks, podcasts, and other content available on BookVault are protected by intellectual property laws. You may access content for personal use only. Redistribution, sharing, or reproduction of content is strictly prohibited.' },
  ...
  { title: '9. Limitation of Liability', body: 'To the fullest extent permitted by law, BookVault shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the App.' },
  ...
  { title: '11. Contact', body: 'If you have questions about these Terms, please contact us at legal@bookvault.app.' },
];
